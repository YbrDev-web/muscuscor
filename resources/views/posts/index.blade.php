        ...
        <div class="cards-table">
            @foreach($posts as $post)
                <div class="post-card p-4 bg-white dark:bg-gray-800 rounded-lg shadow">
                    ...
                    <p class="text-gray-600 dark:text-gray-400 mb-4">Catégorie : {{ $post->category->name ?? '-' }}</p>
                    <div class="flex space-x-2">
                        <a href="{{ route('posts.show', $post) }}" class="text-blue-600 hover:underline">Voir</a>
                        <a href="{{ route('posts.edit', $post) }}" class="text-yellow-600 hover:underline">Modifier</a>
